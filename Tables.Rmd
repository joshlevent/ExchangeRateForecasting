...
```{r table5-output, echo=FALSE}
table <- kable(narrow_empirical_results, booktabs = TRUE,
               caption = "Policy Change Sample Empirical Estimation Results") %>%
  kable_styling(full_width = T) %>%
  footnote(general = " ", general_title = "Notes:", footnote_as_chunk = T)
